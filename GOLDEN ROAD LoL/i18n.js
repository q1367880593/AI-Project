(function () {
  ...
  var exact = {
    ...
    "MSI Year": "MSI 年份",
    "Region Filter": "赛区过滤",
    "Checked regions are allowed in Golden Road mode. Leave all unchecked to allow every region.": "勾选的赛区会在 Golden Road 模式中出现。全部不勾选则允许所有赛区。",
    "All": "全选",
    "Clear": "清空",
    "Save Cheats": "保存作弊设置",
    "Cheats apply when you start a new run.": "作弊设置会在开始新一局时生效。",
    "Cheats saved. Start a new run to apply them.": "作弊设置已保存。开始新一局后生效。",
    "No valid team-years in the selected region filter. Using all regions.": "当前赛区过滤下没有可用队伍年份，已改用全部赛区。",
    "RESULTS": "结果",
    "SHARE": "分享",
